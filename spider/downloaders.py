...
from utils.util import stringify_children
import time
import json
import platform
...
from utils.redis_util import get_uniqueid, get_redis
from spider.models import Topic
from utils.constants import KIND_DETAIL, KIND_KEYWORD, KIND_NORMAL
    ...
    def download_wechat_topic_detail(self, data, process_topic):
        ...
        try:
            ...
            if 'antispider' in browser.current_url:
                ...
                print("process_topic:", process_topic)
                time.sleep(randint(1, 5))
